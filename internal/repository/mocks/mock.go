...
func (m *MockAuth) GetUser(username, password string) (entity.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAuthMockRecorder) GetUser(username, password interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUser", reflect.TypeOf((*MockAuth)(nil).GetUser), username, password)
}
